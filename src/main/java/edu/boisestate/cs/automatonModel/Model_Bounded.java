...
public class Model_Bounded extends A_Model<Model_Bounded> {
	...
	Model_Bounded(Automaton automaton, Alphabet alphabet, int boundLength) {
		super(alphabet, boundLength);

		this.automaton = automaton;
		this.modelManager = new BoundedAutomatonModelManager(alphabet, boundLength);
	}

	Model_Bounded(Automaton automaton, Alphabet alphabet) {
		super(alphabet, 0);

		this.automaton = automaton;
	}

	private static Automaton getAutomatonFromBoundedModel(Model_Bounded model) {
	...
	private void ensureBoundedModel(Model_Bounded arg) {
