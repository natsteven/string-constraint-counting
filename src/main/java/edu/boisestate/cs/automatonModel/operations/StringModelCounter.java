...
// MJR 2/11/20 removed references to weighted automaton classes that are now unused.
...
public class StringModelCounter {
	...
	// MJR 2/11/20 removed unused constructors that required weighted automata that have been removed.
	/*
