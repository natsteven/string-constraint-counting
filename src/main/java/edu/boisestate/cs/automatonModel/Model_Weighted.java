...
import static edu.boisestate.cs.automaton.WeightedMinimizationOperations.minimizeHopcroft;

public class Model_Weighted extends A_Model<Model_Weighted> {
    ...
    Model_Weighted(WeightedAutomaton[] automata, Alphabet alphabet, int initialBoundLength) {
        super(alphabet, initialBoundLength);

        this.automata = new WeightedAutomaton[automata.length];
        setAutomata(automata);

        this.modelManager = new Model_Weighted_Manager(alphabet, initialBoundLength);
    }

    private static WeightedAutomaton[] getAutomataFromWeightedModel(Model_Weighted model) {
        //return ((Model_Weighted)model).automata;
        return model.automata;
    ...
    @Override
    public Model_Weighted assertContainedInOther(Model_Weighted containingModel) {
        ...
        if (containing.isEmpty()) {
            ...
            return new Model_Weighted(a, alphabet, 0);
        }
        ...
        return new Model_Weighted(results, this.alphabet, this.boundLength);
    }

    @Override
    public Model_Weighted assertContainsOther(Model_Weighted containedModel) {
    ...
    @Override
    public Model_Weighted assertEmpty() {
        // get resulting automata
        WeightedAutomaton[] results = performBinaryAutomatonOperation(automata, makeEmptyString(), intersectOp, boundLength);

        // return new model from resulting automata
        return new Model_Weighted(results, this.alphabet, 0);
    }

     @Override
    public Model_Weighted assertEndsOther(Model_Weighted containingModel) {
        //ensureWeightedModel(containingModel);
    ...
    @Override
    public Model_Weighted assertEndsWith(Model_Weighted endingModel) {
    ...
    @Override
    public Model_Weighted assertEquals(Model_Weighted equalModel) {
    ...
    @Override
    public Model_Weighted assertEqualsIgnoreCase(Model_Weighted equalModel) {
        //ensureWeightedModel(equalModel);
    ...
    @Override
    public Model_Weighted assertHasLength(int min, int max) {
        // check min and max
        if (min > max) {
            WeightedAutomaton[] a = new WeightedAutomaton[] {makeEmpty()};
            return new Model_Weighted(a, alphabet, 0);
        ...
        // return new model from resulting automata
        return new Model_Weighted(results, this.alphabet, newBoundLength);
    }

     @Override
    public Model_Weighted assertNotContainedInOther(Model_Weighted notContainingModel) {
        ...
        if (notContaining.isEmpty() || this.isEmpty()) {
            ...
            return new Model_Weighted(a, this.alphabet, 0);
        }
    ...
    @Override
    public Model_Weighted assertNotContainsOther(Model_Weighted notContainedModel) {
    ...
    @Override
    public Model_Weighted assertNotEmpty() {
        // get resulting automata
    ...
    @Override
    public Model_Weighted assertNotEndsOther(Model_Weighted notContainingModel) {
        //ensureWeightedModel(notContainingModel);
    ...
    @Override
    public Model_Weighted assertNotEndsWith(Model_Weighted notEndingModel) {
    ...
    @Override
    public Model_Weighted assertNotEquals(Model_Weighted notEqualModel) {
    ...
    @Override
    public Model_Weighted assertNotEqualsIgnoreCase(Model_Weighted notEqualModel) {
        //ensureWeightedModel(notEqualModel);
    ...
    @Override
    public Model_Weighted assertNotStartsOther(Model_Weighted notStartingModel) {
    ...
    @Override
    public Model_Weighted assertNotStartsWith(Model_Weighted notStartsModel) {
    ...
    @Override
    public Model_Weighted assertStartsOther(Model_Weighted containingModel) {
        //ensureWeightedModel(containingModel);
    ...
    @Override
    public Model_Weighted assertStartsWith(Model_Weighted startingModel) {
    ...
    @Override
    public Model_Weighted concatenate(Model_Weighted argModel) {
...
//        }
    ...
    @Override
    public Model_Weighted delete(int start, int end) {
        // get resulting automata
    ...
    @Override
    public boolean equals(Model_Weighted arg) {
        // check if arg model is weighted model
        if (arg instanceof Model_Weighted) {
            // cast arg model
            Model_Weighted argModel = (Model_Weighted) arg;
    ...
    @Override
    public Model_Weighted intersect(Model_Weighted argModel) {
        //ensureWeightedModel(argModel);
        ...
        // return weighted model from automata
        return new Model_Weighted(results, this.alphabet, boundLength);
    }

    @Override
    public Model_Weighted insert(int offset, Model_Weighted argModel) {
        //ensureWeightedModel(argModel);
    ...
    @Override
    public Model_Weighted replace(char find, char replace) {
        // get resulting automata
    ...
    @Override
    public Model_Weighted replace(String find, String replace) {
        // get resulting automata
    ...
    @Override
    public Model_Weighted replaceChar() {
        // get resulting automata
    ...
    @Override
    public Model_Weighted replaceFindKnown(char find) {
        // get resulting automata
    ...
    @Override
    public Model_Weighted replaceReplaceKnown(char replace) {
        // get resulting automata
    ...
    @Override
    public Model_Weighted substring(int start, int end) {
        // get resulting automata
    ...
    @Override
    public Model_Weighted setCharAt(int offset, Model_Weighted argModel) {
        //ensureWeightedModel(argModel);
    ...
    @Override
    public Model_Weighted setLength(int length) {
        // get resulting automata
        ...
        // return new model from resulting automata
        return new Model_Weighted(results, this.alphabet, length);
    }

    @Override
    public Model_Weighted suffix(int start) {
        // get resulting automata
    ...
    @Override
    public Model_Weighted toLowercase() {
        // get resulting automata
    ...
    @Override
    public Model_Weighted toUppercase() {
        // get resulting automata
